                        ...
                        return Center(
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                'No folders found !',
                                style: Theme.of(context).textTheme.headline6.copyWith(color: textColor, fontWeight: FontWeight.bold),
                              ),
                            ],
                          )
                        );
...
class MyAppbar extends AppBar {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      elevation: 0.0,
      titleSpacing: 0.0,
      title: Text(Strings.app_name, style: Theme.of(context).textTheme.headline6.copyWith(color: textColor, fontWeight: FontWeight.bold),),
      actions: <Widget>[
        new IconButton(
...
class MySelectedAppbar extends AppBar {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      elevation: 0.0,
      titleSpacing: 0.0,
      title: Text(selectedItem.name, style: Theme.of(context).textTheme.headline6.copyWith(color: textColor, fontWeight: FontWeight.bold),),
      actions: <Widget>[
        new IconButton(
